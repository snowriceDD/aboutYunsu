...
export const Items = (data:any) => {
    ...
    return (
        <S.ItemsCard>
            ...
            {(data.data.link !== "string") ? <a className='inlink' href={data.data.link}><img src={inlink} alt='해당 작품의 배포 주소'></img></a>: <a/>}
            {(data.data.github !== "string") ? <a className='github' href={data.data.github}><img src={github} alt='해당 작품의 github 주소'></img></a> : <a/>}
